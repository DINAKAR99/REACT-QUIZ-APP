...
const SupportPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (userConfirmation) {
      ...
      const serviceId = "service_qfzpqge";
      const templateId = "template_bgmbjpk";
      const publicKey = "PqHHzqykmP2VnrjyB";
        ...
        <div class="container ">
          <div class="row justify-content-md-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6 ">
              ...
              <p>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; Want to send using Email application ? &nbsp;
                <a href="mailto:karenguladinakar@gmail.com?subject=Support regarding Brainy Bits&body=Dear BrainyBits Team ,">
              ...
              <div class="row     p-5">
                ...
                <div class="col-12">
                  ...
                  <textarea
                    ...
                    required
                    value={message}
                    title="Please enter a name with no leading spaces, special characters, or numbers"
